...
var GridRowSales = (function (_super) {
    __extends(GridRowSales, _super);
    function GridRowSales() {
        _super.call(this);
        this.delCheck = this.delCheck.bind(this);
        this.modify = this.modify.bind(this);
    }
    GridRowSales.prototype.delCheck = function (i, chd) {
        this.props.delCheck(i, chd);
    };
    GridRowSales.prototype.modify = function () {
        this.props.updateType(this.props.primKey);
    };
    GridRowSales.prototype.render = function () {
        return React.createElement("tr", null, React.createElement("td", {"className": "text-center"}, React.createElement(GridCheckDel, {"iKey": this.props.ikey, "chd": this.props.itemData.check_del, "delCheck": this.delCheck})), React.createElement("td", {"className": "text-center"}, React.createElement(GridButtonModify, {"modify": this.modify})), React.createElement("td", null, this.props.itemData.sales_no), React.createElement("td", null, this.props.itemData.sales_name), React.createElement("td", null, moment(this.props.itemData.join_date).format(dt.dateFT)), React.createElement("td", null, this.props.itemData.sales_state));
    };
    GridRowSales.defaultProps = {};
    return GridRowSales;
})(React.Component);
var GirdFormSales = (function (_super) {
    __extends(GirdFormSales, _super);
    function GirdFormSales() {
        _super.call(this);
    ...
    GirdFormSales.prototype.componentDidMount = function () {
        this.queryGridData(1);
    };
    GirdFormSales.prototype.gridData = function (page) {
        var parms = {
            page: 0
        };
        if (page == 0) {
    ...
    GirdFormSales.prototype.queryGridData = function (page) {
        this.gridData(page)
    ...
    GirdFormSales.prototype.handleSubmit = function (e) {
        var _this = this;
        e.preventDefault();
    ...
    GirdFormSales.prototype.deleteSubmit = function () {
        if (!confirm('確定是否刪除?')) {
            return;
        }
        var ids = [];
    ...
    GirdFormSales.prototype.handleSearch = function (e) {
        e.preventDefault();
        this.queryGridData(0);
        return;
    };
    GirdFormSales.prototype.delCheck = function (i, chd) {
        var newState = this.state;
        this.state.gridData.rows[i].check_del = !chd;
        this.setState(newState);
    };
    GirdFormSales.prototype.checkAll = function () {
        var newState = this.state;
    ...
    GirdFormSales.prototype.insertType = function () {
        this.setState({ edit_type: 1, fieldData: { sales_id: 0 } });
    };
    GirdFormSales.prototype.updateType = function (id) {
        var _this = this;
    ...
    GirdFormSales.prototype.noneType = function () {
        this.gridData(0)
            .done(function (data, textStatus, jqXHRdata) {
    ...
    GirdFormSales.prototype.changeFDValue = function (name, e) {
        this.setInputValue(this.props.fdName, name, e);
    };
    GirdFormSales.prototype.changeGDValue = function (name, e) {
        this.setInputValue(this.props.gdName, name, e);
    };
    GirdFormSales.prototype.setInputValue = function (collentName, name, e) {
        var input = e.target;
    ...
    GirdFormSales.prototype.openModalSales = function () {
        this.setState({ isShowModalSales: true });
    };
    GirdFormSales.prototype.closeModalSales = function () {
        this.setState({ isShowModalSales: false });
    };
    GirdFormSales.prototype.queryModalSales = function () {
        var _this = this;
    ...
    GirdFormSales.prototype.setModalSalesKeyword = function (e) {
        var input = e.target;
        var getObj = this.state.ModalDataSales;
        getObj.search.keyword = input.value;
        this.setState({ ModalDataSales: getObj });
    };
    GirdFormSales.prototype.selectModalSales = function (sales_id, e) {
        var _this = this;
    ...
    GirdFormSales.prototype.render = function () {
        ...
        if (this.state.edit_type == 0) {
            ...
            if (this.state.isShowModalSales) {
                out_ModalSales = (React.createElement(ModalSales, {"bsSize": "large", "title": "選擇推薦人", "onRequestHide": this.closeModalSales}, React.createElement("div", {"className": "modal-body"}, React.createElement("div", {"className": "table-header"}, React.createElement("div", {"className": "table-filter"}, React.createElement("div", {"className": "form-inline"}, React.createElement("div", {"className": "form-group"}, React.createElement("label", null, "會員姓名或編號"), " ", React.createElement("input", {"type": "text", "className": "form-control input-sm", "onChange": this.setModalSalesKeyword, "value": this.state.ModalDataSales.search.keyword})), React.createElement("div", {"className": "form-group"}, React.createElement("button", {"className": "btn-primary btn-sm", "onClick": this.queryModalSales}, React.createElement("i", {"className": "fa-search"}), " 搜尋"))))), React.createElement("table", {"className": "table-condensed"}, React.createElement("tbody", null, React.createElement("tr", null, React.createElement("th", {"className": "col-xs-3"}, "會員編號"), React.createElement("th", {"className": "col-xs-3"}, "姓名")), this.state.ModalDataSales.queryItems.map(function (itemData, i) {
            ...
            outHtml = (React.createElement("div", null, React.createElement("ul", {"className": "breadcrumb"}, React.createElement("li", null, React.createElement("i", {"className": "fa-list-alt"}), " ", this.props.menuName)), React.createElement("h4", {"className": "title"}, " ", this.props.caption, " 基本資料維護"), React.createElement("form", {"className": "form-horizontal", "onSubmit": this.handleSubmit}, React.createElement("div", {"className": "col-xs-12"}, React.createElement("div", {"className": "alert alert-warning"}, React.createElement("p", null, React.createElement("strong", {"className": "text-danger"}, "紅色標題"), " 為必填欄位。"))), React.createElement("div", {"className": "col-xs-6"}, React.createElement("div", {"className": "form-group"}, React.createElement("label", {"className": "col-xs-2 control-label text-danger"}, "會員編號"), React.createElement("div", {"className": "col-xs-10"}, React.createElement("input", {"type": "text", "className": "form-control", "onChange": this.changeFDValue.bind(this, 'sales_no'), "value": fieldData.sales_no, "maxLength": 16, "disabled": this.state.edit_type == 2, "required": true}))), React.createElement("div", {"className": "form-group"}, React.createElement("label", {"className": "col-xs-2 control-label text-danger"}, "姓名"), React.createElement("div", {"className": "col-xs-10"}, React.createElement("input", {"type": "text", "className": "form-control", "onChange": this.changeFDValue.bind(this, 'sales_name'), "value": fieldData.sales_name, "maxLength": 32, "required": true}))), React.createElement("div", {"className": "form-group"}, React.createElement("label", {"className": "col-xs-2 control-label text-danger"}, "加入日期"), React.createElement("div", {"className": "col-xs-10"}, React.createElement(InputDate, {"id": "join_date", "onChange": this.changeFDValue, "field_name": "join_date", "value": fieldData.join_date, "disabled": false, "required": true, "ver": 1})))), React.createElement("div", {"className": "col-xs-6"}, React.createElement("div", {"className": "form-group"}, React.createElement("label", {"className": "col-xs-2 control-label text-danger"}, "生日"), React.createElement("div", {"className": "col-xs-10"}, React.createElement(InputDate, {"id": "birthday", "onChange": this.changeFDValue, "field_name": "birthday", "value": fieldData.birthday, "disabled": false, "required": true, "ver": 1}))), React.createElement("div", {"className": "form-group"}, React.createElement("label", {"className": "col-xs-2 control-label text-danger"}, "推薦人"), React.createElement("div", {"className": "col-xs-10"}, React.createElement("div", {"className": "input-group"}, React.createElement("input", {"type": "text", "className": "form-control", "onChange": this.changeFDValue.bind(this, 'recommend_name'), "value": fieldData.recommend_name, "maxLength": 32, "required": true}), React.createElement("span", {"className": "input-group-btn"}, React.createElement("a", {"className": "btn", "onClick": this.openModalSales, "disabled": false}, React.createElement("i", {"className": "fa fa-search"}))))))), React.createElement("div", {"className": "col-xs-12"}, React.createElement("div", {"className": "form-action"}, React.createElement("div", {"className": "col-xs-10 col-xs-offset-2"}, React.createElement("button", {"type": "submit", "className": "btn-primary"}, React.createElement("i", {"className": "fa-check"}), " 儲存"), " ", React.createElement("button", {"type": "button", "onClick": this.noneType}, React.createElement("i", {"className": "fa-times"}), " 回前頁"))))), out_ModalSales));
        }
        return outHtml;
    };
    GirdFormSales.defaultProps = {
        fdName: 'fieldData',
        gdName: 'searchData',
        apiPathName: gb_approot + 'api/Sales'
    };
    return GirdFormSales;
})(React.Component);
var dom = document.getElementById('page_content');
React.render(React.createElement(GirdFormSales, {"caption": gb_caption, "menuName": gb_menuname, "iconClass": "fa-list-alt"}), dom);
