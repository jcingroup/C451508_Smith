...
var GirdForm = (function (_super) {
    ...
    GirdForm.prototype.render = function () {
        ...
        if (this.state.edit_type == 0) {
            ...
            outHtml = (React.createElement("div", null, React.createElement("ul", {"className": "breadcrumb"}, React.createElement("li", null, React.createElement("i", {"className": "fa-list-alt"}), " ", this.props.menuName)), React.createElement("h4", {"className": "title"}, " ", this.props.caption, " 基本資料維護"), React.createElement("form", {"className": "form-horizontal", "onSubmit": this.handleSubmit}, React.createElement("div", {"className": "col-xs-12"}, React.createElement("div", {"className": "alert alert-warning"}, React.createElement("p", null, React.createElement("strong", {"className": "text-danger"}, "紅色標題"), " 為必填欄位。")), React.createElement("div", {"className": "form-group"}, React.createElement("label", {"className": "col-xs-1 control-label text-danger"}, "品名"), React.createElement("div", {"className": "col-xs-5"}, React.createElement("input", {"type": "text", "className": "form-control", "onChange": this.changeFDValue.bind(this, 'product_name'), "value": fieldData.product_name, "maxLength": 256, "required": true}))), React.createElement("div", {"className": "form-group"}, React.createElement("label", {"className": "col-xs-1 control-label text-danger"}, "單價"), React.createElement("div", {"className": "col-xs-5"}, React.createElement("input", {"type": "number", "className": "form-control", "onChange": this.changeFDValue.bind(this, 'price'), "value": fieldData.price, "required": true}))), React.createElement("div", {"className": "form-group"}, React.createElement("label", {"className": "col-xs-2 control-label text-danger"}, "KV"), React.createElement("div", {"className": "col-xs-6"}, React.createElement("input", {"type": "number", "className": "form-control", "onChange": this.changeFDValue.bind(this, 'kvalue'), "value": fieldData.kvalue, "required": true}))), React.createElement("div", {"className": "form-group"}, React.createElement("label", {"className": "col-xs-2 control-label text-danger"}, "產品分類"), React.createElement("div", {"className": "col-xs-6"}, React.createElement("select", {"className": "form-control", "value": fieldData.product_category_id, "onChange": this.changeFDValue.bind(this, 'product_category_id')}, this.state.category_option.map(function (itemData, i) {
...
React.render(React.createElement(GirdForm, {"caption": gb_caption, "menuName": gb_menuname, "iconClass": "fa-list-alt"}), dom);
