    ...
    var GirdForm = (function (_super) {
        ...
        GirdForm.prototype.render = function () {
            ...
            if (this.state.edit_type == 0) {
                ...
                outHtml =
                    (React.createElement("div", null, React.createElement("ul", {"className": "breadcrumb"}, React.createElement("li", null, React.createElement("i", {"className": "fa-list-alt"}), " ", this.props.menuName)), React.createElement("h3", {"className": "title"}, this.props.caption), React.createElement("form", {"onSubmit": this.handleSearch}, React.createElement("div", {"className": "table-responsive"}, React.createElement("div", {"className": "table-header"}, React.createElement("div", {"className": "table-filter"}, React.createElement("div", {"className": "form-inline"}, React.createElement("div", {"className": "form-group"}, React.createElement("label", null, "產品名稱"), " ", React.createElement("input", {"type": "text", "className": "form-control", "value": searchData.name, "onChange": this.changeGDValue.bind(this, 'name'), "placeholder": "請輸入關鍵字..."}), " ", React.createElement("button", {"className": "btn-primary", "type": "submit"}, React.createElement("i", {"className": "fa-search"}), " 搜尋"))))), React.createElement("table", null, React.createElement("thead", null, React.createElement("tr", null, React.createElement("th", {"className": "col-xs-1 text-center"}, React.createElement("label", {"className": "cbox"}, React.createElement("input", {"type": "checkbox", "checked": this.state.checkAll, "onChange": this.checkAll}), React.createElement("i", {"className": "fa-check"}))), React.createElement("th", {"className": "col-xs-1 text-center"}, "修改"), React.createElement("th", {"className": "col-xs-2"}, "產品分類"), React.createElement("th", {"className": "col-xs-2"}, "產品名稱"), React.createElement("th", {"className": "col-xs-2"}, "單價"), React.createElement("th", {"className": "col-xs-2"}, "狀態"))), React.createElement("tbody", null, this.state.gridData.rows.map(function (itemData, i) {
                ...
                outHtml = (React.createElement("div", null, React.createElement("h3", {"className": "title"}, " ", this.props.caption, " 基本資料維護"), React.createElement("form", {"className": "form-horizontal", "onSubmit": this.handleSubmit}, React.createElement("div", {"className": "col-xs-12"}, React.createElement("div", {"className": "alert alert-warning"}, React.createElement("p", null, React.createElement("strong", {"className": "text-danger"}, "紅色標題"), " 為必填欄位。")), React.createElement("div", {"className": "form-group"}, React.createElement("label", {"className": "col-xs-2 control-label text-danger"}, "產品分類"), React.createElement("div", {"className": "col-xs-4"}, React.createElement("select", {"className": "form-control", "value": fieldData.category_id, "onChange": this.changeFDValue.bind(this, 'category_id')}, this.state.category_option.map(function (itemData, i) {
                ...
                })))), React.createElement("div", {"className": "form-group"}, React.createElement("label", {"className": "col-xs-2 control-label text-danger"}, "產品名稱"), React.createElement("div", {"className": "col-xs-4"}, React.createElement("input", {"type": "text", "className": "form-control", "onChange": this.changeFDValue.bind(this, 'product_name'), "value": fieldData.product_name, "maxLength": 64, "required": true})), React.createElement("small", {"className": "help-inline col-xs-6"}, "最多64個字", React.createElement("span", {"className": "text-danger"}, "(必填) "))), React.createElement("div", {"className": "form-group"}, React.createElement("label", {"className": "col-xs-2 control-label text-danger"}, "單價"), React.createElement("div", {"className": "col-xs-4"}, React.createElement("input", {"type": "number", "className": "form-control", "onChange": this.changeFDValue.bind(this, 'price'), "value": fieldData.price, "required": true}))), React.createElement("div", {"className": "form-group"}, React.createElement("label", {"className": "col-xs-2 control-label"}, "排序"), React.createElement("div", {"className": "col-xs-4"}, React.createElement("input", {"type": "number", "className": "form-control", "onChange": this.changeFDValue.bind(this, 'sort'), "value": fieldData.sort})), React.createElement("small", {"className": "col-xs-2 help-inline"}, "數字越大越前面")), React.createElement("div", {"className": "form-group"}, React.createElement("label", {"className": "col-xs-2 control-label"}, "狀態"), React.createElement("div", {"className": "col-xs-4"}, React.createElement("div", {"className": "radio-inline"}, React.createElement("label", null, React.createElement("input", {"type": "radio", "name": "i_Hide", "value": true, "checked": fieldData.i_Hide === true, "onChange": this.changeFDValue.bind(this, 'i_Hide')}), React.createElement("span", null, "隱藏"))), React.createElement("div", {"className": "radio-inline"}, React.createElement("label", null, React.createElement("input", {"type": "radio", "name": "i_Hide", "value": false, "checked": fieldData.i_Hide === false, "onChange": this.changeFDValue.bind(this, 'i_Hide')}), React.createElement("span", null, "顯示"))))), React.createElement("div", {"className": "form-group"}, React.createElement("label", {"className": "col-xs-2 control-label"}, "產品內容"), React.createElement("div", {"className": "col-xs-6"}, React.createElement("textarea", {"cols": 30, "rows": 3, "className": "form-control", "value": fieldData.product_content, "onChange": this.changeFDValue.bind(this, 'product_content'), "maxLength": 256}))), React.createElement("div", {"className": "form-action text-right"}, React.createElement("div", {"className": "col-xs-5"}, React.createElement("button", {"type": "submit", "className": "btn-primary"}, React.createElement("i", {"className": "fa-check"}), " 儲存"), " ", React.createElement("button", {"type": "button", "onClick": this.noneType}, React.createElement("i", {"className": "fa-times"}), " 回前頁")))))));
            }
            return outHtml;
        };
