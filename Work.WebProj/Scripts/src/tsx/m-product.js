...
(function (Product) {
    ...
    var GirdForm = (function (_super) {
        ...
        GirdForm.prototype.changePageSize = function (e) {
            var input = e.target;
        ...
        GirdForm.prototype.render = function () {
            ...
            if (this.state.edit_type == 0) {
                ...
                outHtml =
                    (React.createElement("div", null, React.createElement("h3", {className: "title"}, this.props.caption), React.createElement("form", {onSubmit: this.handleSearch}, React.createElement("div", {className: "table-responsive"}, React.createElement("div", {className: "table-header"}, React.createElement("div", {className: "table-filter"}, React.createElement("div", {className: "form-inline"}, React.createElement("div", {className: "form-group col-md-6"}, React.createElement("label", null, "產品名稱"), " ", React.createElement("input", {type: "text", className: "form-control", value: searchData.name, onChange: this.changeGDValue.bind(this, 'name'), placeholder: "請輸入關鍵字..."}), " ", React.createElement("label", null, "產品分類"), " ", React.createElement("select", {className: "form-control", value: searchData.product_category_id, onChange: this.changeGDValue.bind(this, 'product_category_id')}, React.createElement("option", {value: ""}, "全部分類"), this.state.category_option.map(function (itemData, i) {
