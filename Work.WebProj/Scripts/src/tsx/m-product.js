    ...
    var GirdForm = (function (_super) {
        ...
        GirdForm.prototype.render = function () {
            ...
            if (this.state.edit_type == 0) {
                ...
                outHtml =
                    (React.createElement("div", null, React.createElement("h3", {"className": "title"}, this.props.caption), React.createElement("form", {"onSubmit": this.handleSearch}, React.createElement("div", {"className": "table-responsive"}, React.createElement("div", {"className": "table-header"}, React.createElement("div", {"className": "table-filter"}, React.createElement("div", {"className": "form-inline"}, React.createElement("div", {"className": "form-group"}, React.createElement("label", null, "產品名稱"), " ", React.createElement("input", {"type": "text", "className": "form-control", "value": searchData.name, "onChange": this.changeGDValue.bind(this, 'name'), "placeholder": "請輸入關鍵字..."}), " ", React.createElement("button", {"className": "btn-primary", "type": "submit"}, React.createElement("i", {"className": "fa-search"}), " 搜尋"))))), React.createElement("table", null, React.createElement("thead", null, React.createElement("tr", null, React.createElement("th", {"className": "col-xs-1 text-center"}, React.createElement("label", {"className": "cbox"}, React.createElement("input", {"type": "checkbox", "checked": this.state.checkAll, "onChange": this.checkAll}), React.createElement("i", {"className": "fa-check"}))), React.createElement("th", {"className": "col-xs-1 text-center"}, "修改"), React.createElement("th", {"className": "col-xs-2"}, "產品分類"), React.createElement("th", {"className": "col-xs-2"}, "產品名稱"), React.createElement("th", {"className": "col-xs-2"}, "單價"), React.createElement("th", {"className": "col-xs-2"}, "狀態"))), React.createElement("tbody", null, this.state.gridData.rows.map(function (itemData, i) {
